...
* 
* Al principio se pide una cantidad de apuesta. Después, se imprime en ASCII los tres slots con un valor aleatorio pero no dan puntos
*  y se imprime un menú para elegir cómo continuar. Tras ello, el usuario introduce T para tirar de la palanca y hacer una tirada.
